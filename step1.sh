...
# create org
hammer organization create --name "$ORG_NAME" --label "$ORG" --description "$ORG_DESCRIPTION"

# upload manifest
hammer subscription upload --organization "$ORG_NAME" --file "$subscription_manifest_loc"
